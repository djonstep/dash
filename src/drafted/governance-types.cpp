...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EziocoinNetwork") type = EziocoinNetwork;
    if(strType == "EziocoinNetworkVariable") type = EziocoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EziocoinNetwork) s = "EziocoinNetwork";
    if(type == EziocoinNetworkVariable) s = "EziocoinNetworkVariable";
