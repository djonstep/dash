 ...
 *
 *   // network
 *   CEziocoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.eziocoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEziocoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CEziocoinNetwork(UniValue objIn)
    {
...
// // can be under: EziocoinNetwork
// //   -- signature requirements : Key1(User)
// class CEziocoinNetworkVariable : public CGovernanceObject
// {
// private:
