...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Eziocoin Core eziocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  eziocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eziocoin transaction") + "\n" +
              "  eziocoin-tx [options] -create [commands]   " + _("Create hex-encoded eziocoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded eziocoin transaction
