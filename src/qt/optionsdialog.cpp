    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("EZIOCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("EZIOCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("EZIOCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("EZIOCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("EZIOCOIN-traditional"), QVariant("trad"));
