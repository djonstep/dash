...
#define BOOST_TEST_MODULE Eziocoin Test Suite

#include "test_eziocoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_eziocoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
