...
Eziocoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Eziocoin Core, where everyone uses
...
pay attention to for reviewers of Eziocoin Core code.

General Eziocoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Eziocoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
