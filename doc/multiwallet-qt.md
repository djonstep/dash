...
Only requiring some minor changes is eziocoin.cpp.
...
Changes to eziocoin.cpp
----------------------
eziocoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
